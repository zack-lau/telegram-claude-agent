...
import { isGifMedia, runMagika, type MagikaResult } from "../../media/mime.js";
...
export async function resolveMedia(
  ...
  const contentType = magikaResult?.mimeType ?? saved.contentType;
  return { path: saved.path, contentType, placeholder, magikaResult };
}
